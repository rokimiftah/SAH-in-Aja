    ...
    <section className="py-12 sm:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <motion.div
          ...
          className="motion-hidden mx-auto mb-8 max-w-2xl text-center sm:mb-12"
        >
        ...
        <div className="grid gap-4 sm:gap-5 md:grid-cols-2">
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.5 }}
            className="motion-hidden rounded-lg border border-gray-200 bg-white p-5 shadow-[0_4px_15px_rgba(239,68,68,0.1)] sm:rounded-xl sm:p-6"
          >
